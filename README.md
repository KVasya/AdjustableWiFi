...
![Figure 0. Experimental setup. Two HackRF (https://greatscottgadgets.com/hackrf/) devices connected to host notebook PC]('https://github.com/KVasya/AdjustableWiFi/edit/gpflow/GNURadio_companion.png')
